...
namespace Pie.Math.ForInt64
{
    ...
    public struct Fraction : Fraction<long>, IComparable<Fraction>, IEquatable<Fraction>, ICloneable
    {
        ...
        /// </summary>
        /// <returns>The converted fraction.</returns>
        public Pie.Math.ForBigInteger.Fraction AsBigIntegerFraction() { return new Pie.Math.ForBigInteger.Fraction(this.Numerator, this.Denominator, this.AutoReduce); }
