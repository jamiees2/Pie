...
namespace Pie.Math.ForBigInteger
{
    using System;
    ...
    public struct Fraction : Fraction<BigInteger>, IComparable<Fraction>, IEquatable<Fraction>, ICloneable
    {
        ...
        {
            BigInteger max = fraction.Denominator;
        ...
        public Pie.Math.ForInt64.Fraction AsInt64Fraction() { return new Pie.Math.ForInt64.Fraction((long)this.Numerator, (long)this.Denominator, this.AutoReduce); }

        /// <summary>
        /// Converts the fraction to an Int32 fraction.
        /// </summary>
        /// <returns>The converted fraction.</returns>
        public Pie.Math.ForInt32.Fraction AsInt32Fraction() { return new Pie.Math.ForInt32.Fraction((int)this.Numerator, (int)this.Denominator, this.AutoReduce); }
