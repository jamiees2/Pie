...
namespace Pie.Math.ForDouble
{
    ...
    public class Matrix : MatrixBase<double, Matrix>
    {
        ...
        public abstract class Accessor : IEnumerable<Vector>
        {
            ...
            /// <summary>
            /// Gets or sets the <see cref="Pie.Math.ForDouble.Vector"/> at the specified index.
            /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForDouble.Matrix"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForDouble.Matrix"/> to an array of numbers.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Pie.Math.ForDouble.Matrix"/> to <see cref="Pie.Math.ForDouble.Vector"/>.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>
        /// The result of the conversion.
