...
namespace Pie.Math.ForDouble
{
    ...
    public class Vector : VectorBase<double, Vector>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForDouble.Vector"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForDouble.Vector"/> to an array of numbers.
        /// </summary>
