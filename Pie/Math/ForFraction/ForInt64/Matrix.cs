...
using System.Text;
using Pie.Strings;
using Fraction = Pie.Math.ForInt64.Fraction;

namespace Pie.Math.ForFraction.ForInt64
{
    /// <summary>
    /// A matrix.
    /// </summary>
    ...
    public class Matrix : MatrixBase<Fraction, Matrix>
    {
        ...
        public abstract class Accessor : IEnumerable<Vector>
        {
            ...
            /// <summary>
            /// Gets or sets the <see cref="Pie.Math.ForFraction.ForInt64.Vector"/> at the specified index.
            /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForFraction.ForInt64.Matrix"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForFraction.ForInt64.Matrix"/> to an array of numbers.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Pie.Math.ForFraction.ForInt64.Matrix"/> to <see cref="Pie.Math.ForFraction.ForInt64.Vector"/>.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>
        /// The result of the conversion.
