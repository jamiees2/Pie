...
namespace Pie.Math.ForFraction.ForInt32
{
    ...
    public class Vector : VectorBase<Fraction, Vector>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForFraction.ForInt32.Vector"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForFraction.ForInt32.Vector"/> to an array of numbers.
        /// </summary>
