...
namespace Pie.Math.ForFraction.ForBigInteger
{
    ...
    public class Vector : VectorBase<Fraction, Vector>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForFraction.ForBigInteger.Vector"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForFraction.ForBigInteger.Vector"/> to an array of numbers.
        /// </summary>
