...
namespace Pie.Math.ForInt32
{
    ...
    public struct Fraction : Fraction<int>, IComparable<Fraction>, IEquatable<Fraction>, ICloneable, IFormattable
    {
        ...
        public Pie.Math.ForInt64.Fraction AsInt64Fraction() { return new Pie.Math.ForInt64.Fraction(this.Numerator, this.Denominator, this.AutoReduce); }
