...
namespace Pie.Math.ForComplex
{
    ...
    public class Vector : VectorBase<Complex, Vector>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForComplex.Vector"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForComplex.Vector"/> to an array of numbers.
        /// </summary>
