...
namespace Pie.Math.ForComplex
{
    ...
    public class Matrix : MatrixBase<Complex, Matrix>
    {
        ...
        public abstract class Accessor : IEnumerable<Vector>
        {
            ...
            /// <summary>
            /// Gets or sets the <see cref="Pie.Math.ForComplex.Vector"/> at the specified index.
            /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from an array of numbers to <see cref="Pie.Math.ForComplex.Matrix"/>.
        /// </summary>
        /// <param name="elements">The elements.</param>
        /// <returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Pie.Math.ForComplex.Matrix"/> to an array of numbers.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Pie.Math.ForComplex.Matrix"/> to <see cref="Pie.Math.ForComplex.Vector"/>.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>
        /// The result of the conversion.
